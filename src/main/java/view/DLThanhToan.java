...
public class DLThanhToan extends javax.swing.JDialog {
    ...
    Double btHeight = 0.0;
    Double bbHeight = 0.0;
    public DLThanhToan(java.awt.Frame parent, boolean modal,BigDecimal  tienmon, String tenban, String maban, int iddh,String mahd,Date ngayTao,String tenMon,String maDH,BigDecimal tienThayDoi) {
        super(parent, modal);
        initComponents();
        tong = tienmon;
        idDH = iddh;
...
//            }
            ...
            double tiendu = 0;
            tiendu = tongtien - tiendua;
            if (tiendu < 0) {
                tiendu = tiendu * -1;
                this.lbltienthoi.setText("Còn thiếu:");
                this.lbltienthoi.setText(String.valueOf(tiendu));
            } else {
                this.lbltienthoi.setText(String.valueOf(tiendu));
...
//        DonHangCTViewModel dhctview = dhctdao.GetIDDHCT(TenMon, MaDH);
       ...
       // ThucDon td = tddao.getIdByTenMon(TenMon);
       // DonHangChiTiet dhct = dhctdao.getIDByThucDon(TenMon);
