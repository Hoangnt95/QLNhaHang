...
public class HoaDonJDialog extends javax.swing.JDialog {
     ...
     * @param tenBan
     */
    public HoaDonJDialog(java.awt.Frame parent, boolean modal, int IdDH, BigDecimal tien, Date ngaytao, String maBan, String maDH, String tenBan) {
        super(parent, modal);
        initComponents();
    ...
    private void btnInhoadonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInhoadonActionPerformed
        ...
        DLThanhToan thanhtoan = new DLThanhToan(TrangChu.main, true, tiendoi, TenBan, MaBan, idDH, MaHD, date, TenMon, MaDH,tienthaydoi);
