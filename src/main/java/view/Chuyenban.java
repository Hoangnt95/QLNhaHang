        ...
        if (soluongchuyen == 0) {
            ...
            if (soluongchuyen < 0) {
                JOptionPane.showMessageDialog(this, "Bạn không thể chuyển bằng cách trừ sản phẩm");
                    ...
                    DonHang donhang = dhdao.getDHByMaDH(txtmahdbanchuyen.getText());
                    MonAn monan = tddao.getIdByTenMon((String) model.getValueAt(r, 2));
                    List<DonHangChiTiet> listdhct = dhctdao.getDHCT(donhang.getId(), monan.getId());
                ...
                if (soluongbang > soluongchuyen) {
                  ...
                  //  for (DonHangChiTiet dh : listdhct) {
                        DonHangChiTiet newup2 = new DonHangChiTiet();
                       // newup2.setId(dh.getId());
                        newup2.setIdDonHang(donhang);
                        newup2.setIdMonAn(monan);
                        newup2.setSoLuong(newup2.getSoLuong() + soluongchuyen);
...
//                        newup2.setIdDonHang(donhang);
//                        newup2.setIdMonAn(monan);
//                        newup2.setSoLuong(dh.getSoLuong() + soluongchuyen);
//                        newup2.setDonGia(dh.getDonGia());
//                        dhctdao.insert(newup2);
//                    }
                        DonHangChiTiet newup2 = new DonHangChiTiet();
                       // newup2.setId(dh.getId());
